...
impl<'a> SceneGraphBuilder<'a> {
    ...
    fn find_effect_scalar(
        ...
        name_hint: &str,
        layer: &data::Layer,
        #[cfg(feature = "expressions")] evaluator_opt: Option<&mut ExpressionEvaluator>,
        #[cfg(not(feature = "expressions"))] mut evaluator: Option<&mut ()>,
    ) -> f32 {
    ...
    fn get_layer_transform(
        ...
        if layer.ty == 13 {
            // Position
            let pos = match &ks.p {
                data::PositionProperty::Unified(p) => Animator::resolve(
                    p,
                    t_frame,
                    |v| Vec3::from(v.0),
                    Vec3::ZERO,
        ...
        let mut anchor = Animator::resolve(
            &ks.a,
            t_frame,
            |v| Vec3::from(v.0),
            Vec3::ZERO,
        ...
        for item in shapes {
            match item {
                ...
                data::Shape::WigglePath(wg) => {
                    ...
                    let correlation = Animator::resolve(
                        &wg.r,
                        frame,
                        |v| *v,
                        0.0,
                    ...
                    let seed_prop = Animator::resolve(
                        &wg.sh,
                        frame,
                        |v| *v,
                        0.0,
                ...
                data::Shape::Repeater(rp) => {
                    ...
                    let t_anchor_3d = Animator::resolve(
                        &rp.tr.t.a,
                        frame,
                        |v| Vec3::from(v.0),
                        Vec3::ZERO,
                    ...
                    let t_scale_3d = Animator::resolve(
                        &rp.tr.t.s,
                        0.0,
                        |v| Vec3::from(v.0) / 100.0,
                        Vec3::ONE,
                    ...
                    let start_opacity = Animator::resolve(
                        &rp.tr.so,
                        frame,
                        |v| *v / 100.0,
                        1.0,
                    ...
                    let end_opacity = Animator::resolve(
                        &rp.tr.eo,
                        frame,
                        |v| *v / 100.0,
                        1.0,
                ...
                data::Shape::GradientFill(gf) => {
                    ...
                    let raw_stops = Animator::resolve(
                        &gf.g.k,
                        frame,
                        |v| v.clone(),
                        Vec::new(),
    ...
    fn resolve_dash(
        ...
        for prop in props {
            match prop.n.as_deref() {
                ...
                Some("d") | Some("v") | Some("g") => array.push(Animator::resolve(
                    &prop.v,
                    frame,
                    |v| *v,
                    0.0,
    ...
    fn process_masks(
        ...
        for m in masks_props {
            ...
            let expansion = Animator::resolve(
                &m.x,
                frame,
                |v| *v,
                0.0,
